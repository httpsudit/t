...
InputLanguage = env_vars.get("InputLanguage", "en-US")  # Default to English if missing
...
# chrome_options.binary_location = r"C:\Program Files\Google\Chrome Beta\Application\chrome.exe"  # Optional: Chrome Beta
...
# Use webdriver-manager for auto ChromeDriver
